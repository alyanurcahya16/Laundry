...
<body>
    ...
    <div class="hero-area d-flex align-items-center">
        ...
        <div class="hero-contact">
            <div class="hero-text">
                <h1 style="color:#ffffff !important;"><span class="type"></span></h1>
            </div>
...
<div class="feature-section py-5">
    <div class="container">
        <div class="row text-center mb-5">
            <div class="col-lg-12">
                <h2 class="section-main-title fw-bold" style="font-size: 30px;">Mengapa Harus Royal Laundress?</h2>
                <p class="text-muted" style="font-size: 16px;">Royal Laundress adalah solusi laundry terpercaya yang mengutamakan kualitas, kebersihan, dan kenyamanan. Kami hadir dengan pelayanan profesional dan ramah lingkungan.</p>
            </div>
        </div>
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="feature-single-box text-center p-4 bg-white rounded-3 shadow-sm h-100">
                    <div class="feature-icon mb-3">
                        <img src="{{ asset('frontend/assets/images/icon-mesin.png') }}" alt="icon-efisiensi" width="50">
                    </div>
                    <h3 class="feature-title fs-5 fw-semibold">Efisiensi Waktu, Air & Listrik</h3>
                    <p class="feature-text text-muted mt-2">Hemat waktu, air, dan listrik dengan proses cepat dan tepat.</p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="feature-single-box text-center p-4 bg-white rounded-3 shadow-sm h-100">
                    <div class="feature-icon mb-3">
                        <img src="{{ asset('frontend/assets/images/icon-service4.png') }}" alt="icon-kualitas" width="50">
                    </div>
                    <h3 class="feature-title fs-5 fw-semibold">Kualitas Terjamin</h3>
                    <p class="feature-text text-muted mt-2">Cuci bersih maksimal dengan standar tinggi dan profesional.</p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="feature-single-box text-center p-4 bg-white rounded-3 shadow-sm h-100">
                    <div class="feature-icon mb-3">
                        <img src="{{ asset('frontend/assets/images/icon-service3.png') }}" alt="icon-aman" width="50">
                    </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="feature-single-box text-center p-4 bg-white rounded-3 shadow-sm h-100">
                    <div class="feature-icon mb-3">
                        <img src="{{ asset('frontend/assets//images/icon-service2.png') }}" alt="icon-harga" width="50">
                    </div>
                    <h3 class="feature-title fs-5 fw-semibold">Harga Terjangkau</h3>
                    <p class="feature-text text-muted mt-2">Pelayanan premium dengan harga yang ramah di kantong.</p>
                </div>
            </div>
...
<!--==================================================-->
    ...
    <div class="service-single-box">
        <div class="service-thumb">
            <img src="https://i.pinimg.com/1200x/ce/d3/2f/ced32f9c9c16f323dc47f564d764bd51.jpg" alt="daily-kiloan">
        </div>
        <div class="service-content">
            ...
            <div class="service-btn">
                <a href="{{ url('service-details/1') }}">View Details <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
    </div>
</div>
...
<div class="col-lg-12 col-md-12">
    <div class="service-single-box">
        <div class="service-thumb">
            <img src="https://i.pinimg.com/736x/dd/af/eb/ddafeb32c64013d5c53ff6002843ded9.jpg" alt="layanan-laundry" class="w-full h-auto rounded-md shadow-md">
        ...
        <div class="service-content">
            ...
            <div class="service-btn">
                <a href="{{ url('service-details/2') }}">View Details <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
    </div>
</div>
...
<div class="col-lg-12 col-md-12">
    <div class="service-single-box">
        <div class="service-thumb">
            <img src="https://i.pinimg.com/736x/de/cd/1d/decd1d0db77ce2e8525186bcdfd5d1db.jpg" alt="beddings">
        </div>
        <div class="service-content">
            ...
            <div class="service-btn">
                <a href="{{ url('service-details/3') }}">View Details <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
    </div>
</div>
...
<div class="col-lg-12 col-md-12">
    <div class="service-single-box">
        <div class="service-thumb">
            <img src="https://i.pinimg.com/1200x/69/c7/0c/69c70ca20151c621aeff505e56b71aa5.jpg" alt="other-items">
        </div>
        <div class="service-content">
            ...
            <div class="service-btn">
                <a href="{{ url('service-details/4') }}">View Details <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
    </div>
</div>
...
<div class="col-lg-12 col-md-12">
    <div class="service-single-box">
        <div class="service-thumb">
            <img src="https://i.pinimg.com/1200x/f5/39/0b/f5390b634743638c0e4d567ff02cfa6c.jpg" alt="tas-sepatu">
        </div>
        <div class="service-content">
            ...
            <div class="service-btn">
                <a href="{{ url('service-details/5') }}">View Details <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row work">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    ...
                    <p class="section-title-descr">Kami memastikan setiap tahap dikerjakan dengan standar tinggi untuk menjaga kualitas dan kebersihan pakaian Anda.</p>
                </div>
            </div>
