...
@section('content')
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50" id="top">
    <!-- Hero Section -->
    ...
    <div class="container mx-auto px-4 mb-20">
        <div class="grid md:grid-cols-3 gap-6">
            <img src="{{ asset('frontend/assets/images/service-img4.png') }}" alt="gambar 1" class="rounded-xl shadow-lg">
            <img src="{{ asset('frontend/assets/images/service-img5.png') }}" alt="gambar 2" class="rounded-xl shadow-lg">
            <img src="{{ asset('frontend/assets/images/service-img6.png') }}" alt="gambar 3" class="rounded-xl shadow-lg">
        </div>
    </div>
...
@push('scripts')
<script src="http://127.0.0.1:8000/frontend/assets/js/jquery.min.js"></script>
<script src="http://127.0.0.1:8000/frontend/assets/js/bootstrap.bundle.min.js"></script>
